...
jobject myCallObjectMethodV(JNIEnv *env, jobject obj, jmethodID mid, va_list list) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        LOGI("%s[%x]", MAKE_ARG_ARRAY("CallObjectMethodV", list, (Method *) mid),
             oldCallObjectMethod);
...
jobject myCallNonvirtualObjectMethodV(JNIEnv *env, jobject obj, jclass jclass1, jmethodID jid,
                                      va_list list) {
    jobject jobject1 = oldCallNonvirtualObjectMethodV(env, obj, jclass1, jid, list);
    char *backtraceToLogcat_str = (backtraceToLogcat(false));
    if (strstr(backtraceToLogcat_str, libJpush)) {
        LOGI("%s[%x]", MAKE_ARG_ARRAY("oldCallNonvirtualObjectMethodV", list, (Method *) jid),
             jobject1);
    }
    return jobject1;
}
...
jboolean myCallNonvirtualBooleanMethodV(JNIEnv *env, jobject obj, jclass jclass1, jmethodID jid,
                                        va_list list) {
    jboolean jobject1 = oldCallNonvirtualBooleanMethodV(env, obj, jclass1, jid, list);
    char *backtraceToLogcat_str = (backtraceToLogcat(false));
    if (strstr(backtraceToLogcat_str, libJpush)) {
        LOGI("%s[%x]", MAKE_ARG_ARRAY("oldCallNonvirtualBooleanMethodV", list, (Method *) jid),
             jobject1);
    }
    return jobject1;
}
...
jbyte
myCallNonvirtualByteMethodV(JNIEnv *env, jobject obj, jclass jclass1, jmethodID jid, va_list list) {
    jbyte jobject1 = oldCallNonvirtualByteMethodV(env, obj, jclass1, jid, list);
    char *backtraceToLogcat_str = (backtraceToLogcat(false));
    if (strstr(backtraceToLogcat_str, libJpush)) {
        LOGI("%s[%x]", MAKE_ARG_ARRAY("oldCallNonvirtualByteMethodV", list, (Method *) jid),
             jobject1);
    }
    return jobject1;
}
...
jchar
myCallNonvirtualCharMethodV(JNIEnv *env, jobject obj, jclass jclass1, jmethodID jid, va_list list) {
    jchar jobject1 = oldCallNonvirtualCharMethodV(env, obj, jclass1, jid, list);
    char *backtraceToLogcat_str = (backtraceToLogcat(false));
    if (strstr(backtraceToLogcat_str, libJpush)) {
        LOGI("%s[%x]", MAKE_ARG_ARRAY("oldCallNonvirtualCharMethodV", list, (Method *) jid),
             jobject1);
    }
    return jobject1;
}
...
jshort myCallNonvirtualShortMethodV(JNIEnv *env, jobject obj, jclass jclass1, jmethodID jid,
                                    va_list list) {
    jshort jobject1 = oldCallNonvirtualShortMethodV(env, obj, jclass1, jid, list);
    char *backtraceToLogcat_str = (backtraceToLogcat(false));
    if (strstr(backtraceToLogcat_str, libJpush)) {
        LOGI("%s[%x]", MAKE_ARG_ARRAY("oldCallNonvirtualShortMethodV", list, (Method *) jid),
             jobject1);
    }
    return jobject1;
}
...
jint
myCallNonvirtualIntMethodV(JNIEnv *env, jobject obj, jclass jclass1, jmethodID jid, va_list list) {
    jint jobject1 = oldCallNonvirtualIntMethodV(env, obj, jclass1, jid, list);
    char *backtraceToLogcat_str = (backtraceToLogcat(false));
    if (strstr(backtraceToLogcat_str, libJpush)) {
        LOGI("%s[%x]", MAKE_ARG_ARRAY("oldCallNonvirtualIntMethodV", list, (Method *) jid),
             jobject1);
    }
    return jobject1;
}
...
jlong
myCallNonvirtualLongMethodV(JNIEnv *env, jobject obj, jclass jclass1, jmethodID jid, va_list list) {
    jlong jobject1 = oldCallNonvirtualLongMethodV(env, obj, jclass1, jid, list);
    char *backtraceToLogcat_str = (backtraceToLogcat(false));
    if (strstr(backtraceToLogcat_str, libJpush)) {
        LOGI("%s[%x]", MAKE_ARG_ARRAY("oldCallNonvirtualLongMethodV", list, (Method *) jid),
             jobject1);
    }
    return jobject1;
}
...
jfloat myCallNonvirtualFloatMethodV(JNIEnv *env, jobject obj, jclass jclass1, jmethodID jid,
                                    va_list list) {
    jfloat jobject1 = oldCallNonvirtualFloatMethodV(env, obj, jclass1, jid, list);
    char *backtraceToLogcat_str = (backtraceToLogcat(false));
    if (strstr(backtraceToLogcat_str, libJpush)) {
        LOGI("%s[%x]", MAKE_ARG_ARRAY("oldCallNonvirtualFloatMethodV", list, (Method *) jid),
             jobject1);
    }
    return jobject1;
}
...
jdouble myCallNonvirtualDoubleMethodV(JNIEnv *env, jobject obj, jclass jclass1, jmethodID jid,
                                      va_list list) {
    jdouble jobject1 = oldCallNonvirtualDoubleMethodV(env, obj, jclass1, jid, list);
    char *backtraceToLogcat_str = (backtraceToLogcat(false));
    if (strstr(backtraceToLogcat_str, libJpush)) {
        LOGI("%s[%x]", MAKE_ARG_ARRAY("oldCallNonvirtualDoubleMethodV", list, (Method *) jid),
             jobject1);
    }
    return jobject1;
}
...
void
myCallNonvirtualVoidMethodV(JNIEnv *env, jobject obj, jclass jclass1, jmethodID jid, va_list list) {
...
jobject myCallStaticObjectMethodV(JNIEnv *env, jclass jclass1, jmethodID jid, va_list list) {
    ...
    char *backtraceToLogcat_str = (backtraceToLogcat(false));
    if (strstr(backtraceToLogcat_str, libJpush)) {
        LOGI("%s[%x]", MAKE_ARG_ARRAY("oldCallStaticObjectMethodV", list, (Method *) jid),
             jobject1);
    }
    return jobject1;
}
...
jboolean myCallStaticBooleanMethodV(JNIEnv *env, jclass jclass1, jmethodID jid, va_list list) {
    ...
    char *backtraceToLogcat_str = (backtraceToLogcat(false));
    if (strstr(backtraceToLogcat_str, libJpush)) {
        LOGI("%s[%x]", MAKE_ARG_ARRAY("oldCallStaticBooleanMethodV", list, (Method *) jid),
             jobject1);
    }
    return jobject1;
}
...
jdouble myCallStaticDoubleMethodV(JNIEnv *env, jclass jclass1, jmethodID jid, va_list list) {
    ...
    char *backtraceToLogcat_str = (backtraceToLogcat(false));
    if (strstr(backtraceToLogcat_str, libJpush)) {
        LOGI("%s[%x]", MAKE_ARG_ARRAY("oldCallStaticDoubleMethodV", list, (Method *) jid),
             jobject1);
    }
    return jobject1;
}
...
void mySetObjectField(JNIEnv *env, jobject job1, jfieldID jid, jobject job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s", "mySetObjectField", field->clazz->descriptor, field->name,
             field->signature);
    }
}
...
void mySetBooleanField(JNIEnv *env, jobject job1, jfieldID jid, jboolean job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetBooleanField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
void mySetByteField(JNIEnv *env, jobject job1, jfieldID jid, jbyte job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetByteField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
void mySetCharField(JNIEnv *env, jobject job1, jfieldID jid, jchar job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetCharField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
void mySetShortField(JNIEnv *env, jobject job1, jfieldID jid, jshort job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetShortField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
void mySetIntField(JNIEnv *env, jobject job1, jfieldID jid, jint job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetIntField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
void mySetLongField(JNIEnv *env, jobject job1, jfieldID jid, jlong job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetLongField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
void mySetFloatField(JNIEnv *env, jobject job1, jfieldID jid, jfloat job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetFloatField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
void mySetDoubleField(JNIEnv *env, jobject job1, jfieldID jid, jdouble job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetDoubleField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
void mySetStaticObjectField(JNIEnv *env, jclass job1, jfieldID jid, jobject job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetStaticObjectField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
void mySetStaticBooleanField(JNIEnv *env, jclass job1, jfieldID jid, jboolean job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetStaticBooleanField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
void mySetStaticByteField(JNIEnv *env, jclass job1, jfieldID jid, jbyte job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetStaticByteField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
void mySetStaticCharField(JNIEnv *env, jclass job1, jfieldID jid, jchar job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetStaticCharField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
void mySetStaticShortField(JNIEnv *env, jclass job1, jfieldID jid, jshort job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetStaticShortField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
void mySetStaticIntField(JNIEnv *env, jclass job1, jfieldID jid, jint job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetStaticIntField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
void mySetStaticLongField(JNIEnv *env, jclass job1, jfieldID jid, jlong job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetStaticLongField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
void mySetStaticFloatField(JNIEnv *env, jclass job1, jfieldID jid, jfloat job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetStaticFloatField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
void mySetStaticDoubleField(JNIEnv *env, jclass job1, jfieldID jid, jdouble job2) {
    ...
    if (strstr(backtraceToLogcat_str, libJpush)) {
        ...
        LOGI("%s %s %s %s %d", "oldSetStaticDoubleField", field->clazz->descriptor, field->name,
             field->signature, job2);
    }
}
...
jmethodID
myGetMethodID(JNIEnv *env, jclass jclass1, const char *methred_name, const char *methred_sgin) {
...
void jnihookStart(JNIEnv *env) {
    ...
    Cydia::MSHookFunction((void *) anInterface->SetStaticBooleanField,
                          (void *) &mySetStaticBooleanField,
    ...
    Cydia::MSHookFunction((void *) anInterface->CallNonvirtualObjectMethodV,
                          (void *) &myCallNonvirtualObjectMethodV,
                          (void **) &oldCallNonvirtualObjectMethodV);

    Cydia::MSHookFunction((void *) anInterface->SetStaticDoubleField,
                          (void *) &mySetStaticDoubleField,
    ...
    Cydia::MSHookFunction((void *) anInterface->SetStaticFloatField,
                          (void *) &mySetStaticFloatField,
                          (void **) &oldSetStaticFloatField);

    Cydia::MSHookFunction((void *) anInterface->SetStaticShortField,
                          (void *) &mySetStaticShortField,
                          (void **) &oldSetStaticShortField);

    Cydia::MSHookFunction((void *) anInterface->SetStaticObjectField,
                          (void *) &mySetStaticObjectField,
    ...
    Cydia::MSHookFunction((void *) anInterface->CallStaticVoidMethodV,
                          (void *) &myCallStaticVoidMethodV,
                          (void **) &oldCallStaticVoidMethodV);

    Cydia::MSHookFunction((void *) anInterface->CallStaticDoubleMethodV,
                          (void *) &myCallStaticDoubleMethodV,
                          (void **) &oldCallStaticDoubleMethodV);

    Cydia::MSHookFunction((void *) anInterface->CallStaticFloatMethodV,
                          (void *) &myCallStaticFloatMethodV,
                          (void **) &oldCallStaticFloatMethodV);

    Cydia::MSHookFunction((void *) anInterface->CallStaticLongMethodV,
                          (void *) &myCallStaticLongMethodV,
                          (void **) &oldCallStaticLongMethodV);

    Cydia::MSHookFunction((void *) anInterface->CallStaticObjectMethodV,
                          (void *) &myCallStaticObjectMethodV,
                          (void **) &oldCallStaticObjectMethodV);

    Cydia::MSHookFunction((void *) anInterface->CallStaticBooleanMethodV,
                          (void *) &myCallStaticBooleanMethodV,
                          (void **) &oldCallStaticBooleanMethodV);

    Cydia::MSHookFunction((void *) anInterface->CallStaticByteMethodV,
                          (void *) &myCallStaticByteMethodV,
                          (void **) &oldCallStaticByteMethodV);

    Cydia::MSHookFunction((void *) anInterface->CallStaticCharMethodV,
                          (void *) &myCallStaticCharMethodV,
                          (void **) &oldCallStaticCharMethodV);

    Cydia::MSHookFunction((void *) anInterface->CallStaticShortMethodV,
                          (void *) &myCallStaticShortMethodV,
                          (void **) &oldCallStaticShortMethodV);

    Cydia::MSHookFunction((void *) anInterface->CallStaticIntMethodV,
                          (void *) &myCallStaticIntMethodV,
