...
void hook_device() {
    ...
    Cydia::MSHookFunction("libc.so", "__system_property_read", (void *) &new__system_property_read,
                          (void **) &old__system_property_read);
    Cydia::MSHookFunction("libc.so", "__system_property_find", (void *) &new__system_property_find,
                          (void **) &old__system_property_find);
    Cydia::MSHookFunction("libc.so", "__system_property_get", (void *) &new__system_property_get,
